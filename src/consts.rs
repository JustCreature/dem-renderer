...
pub(crate) const DEFAULT_CAM_LAT: f64 = 47.076211;
pub(crate) const DEFAULT_CAM_LON: f64 = 11.687592;
pub(crate) const DEFAULT_CAM_ELEV: f32 = 3258.0;
...
pub(super) const M_PER_DEG: f64 = 111_320.0;

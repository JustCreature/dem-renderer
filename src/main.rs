...
use terrain::{
    ...
    compute_shadow_neon, compute_shadow_neon_parallel, compute_shadow_scalar,
    compute_shadow_scalar_branchless, compute_shadow_scalar_with_azimuth, NormalMap, ShadowMask,
};
